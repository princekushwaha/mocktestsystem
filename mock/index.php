      ...
      <div class="modal fade" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content title1">
            ...
            <!--Footer start-->
            <div class="row footer" style='margin-left: 5rem'>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
            		...
            		<div class="row">
            		<div class="col-md-4">
            		 <img src="image/clg.jpeg" width=100 height=100 alt="KESHAV MAHAVIDAYALAYA" class="img-rounded">
            		 </div>
            		 <div class="col-md-5">
            		<span style="color:#202020; font-family:'typo' ; font-size:18px" >Prince&nbsp&nbspSaurabh&nbsp&nbspVikas</spam>
            		<h4 style="font-family:'typo' ">KESHAV MAHAVIDAYALAYA, DELHI</h4></div></div>
            		</p>
                  </div>
